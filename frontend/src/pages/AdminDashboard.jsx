        ...
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-5 py-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
              ...
              <button
                onClick={() => navigate("/")}
                className="shrink-0 px-3 sm:px-3.5 py-1.5 text-[11px] sm:text-xs font-semibold bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl transition cursor-pointer whitespace-nowrap"
              >
                View Store &rarr;
              </button>
            </div>
